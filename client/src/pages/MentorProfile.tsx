...
export default function MentorProfile() {
  ...
  const type = window.location.pathname.includes('mentor')
    ? 'mentor'
    : 'mentee';
  const user =
    type === 'mentor'
          ...
          <div className="">
            <div className="container mx-auto px-4">
              <div className="flex items-center gap-2 h-14 text-sm">
                ...
                <Link to={`/${type}s`} className="hover:opacity-80">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="text-3xl font-bold">
                      ${(user as Mentor).price} / month
                    </div>
                    <p>
                      Coaching to achieve specific career goals or reach
                      potential.
                    </p>
